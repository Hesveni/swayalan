...
export class Tab3Page implements OnInit {
  ...
  // ✅ Login Admin
  login() {
    this.http.post('https://hesvenita.ti-zone.io/action.php', {
      aksi: 'login_admin',
  ...
  getDatapembelian() {
    this.http.get<any>('https://hesvenita.ti-zone.io/action.php?aksi=get_pembelian')
      .subscribe(
        (res) => {
          if (res.success) {
  ...
  tambahProduk() {
    ...
    this.http.post('https://hesvenita.ti-zone.io/action.php', formData)
      .subscribe(
        (res: any) => {
          if (res.success) {
